        ...
        switch (_c.label) {
            ...
            case 3:
                if (_b) {
                    ...
                    res.status(http_status_1.HTTP_BAD_REQUEST).send("Usuario o contraseña invalidos!");
                }
                return [2 /*return*/];
        }
    });
...
router.post('/register', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nombre, email, password, direccion, user, encryptedPassword, newUser, dbUser;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, nombre = _a.nombre, email = _a.email, password = _a.password, direccion = _a.direccion;
                return [4 /*yield*/, user_model_1.UserModel.findOne({ email: email })];
            case 1:
                user = _b.sent();
                if (user) {
                    res.status(http_status_1.HTTP_BAD_REQUEST).send('El usuario ya existe, inicie sesion');
                    return [2 /*return*/];
                }
